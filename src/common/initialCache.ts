...
export var initialCache = {
  ...
  titlesById: {
    ...
    '12': {
      ...
      description: 'Martin Scorcese\'s high-rolling Wall Street drama is based on the memoirs of stockbroker Jordan Belfort, whose giddy career ended in federal prison.',
    ...
    '60': {
      ...
      description: 'Everyone knows what happened in "Psycho," but this chilling series takes viewers inside Norman Bates\' world before Marion Crane checked in.',
    ...
    '65': {
      ...
      description: 'A father and daughter\'s move to a new home is anything but lucky when they find that a murderous 600-year-old leprechaun is living in their basement.',
    ...
    '80': {
      ...
      genres: 'TV Shows, TV Dramas',
      description: 'Re-creating the dawn of the personal computer era, this digital drama tracks the fates of an industry visionary and his brilliant colleagues.'
    },
    '51': {
      id: '51',
      title: 'Event Horizon',
      rating: 5,
      description: 'After a signal is received from a long-missing spaceship, a rescue ship investigates, but the crew soon realizes something unimaginable has happened.',
    ...
    '62': {
      ...
      title: 'Sharknado',
      rating: 2,
      description: 'When a hurricane swamps Los Angeles, thousands of sharks are swept up in tornadoes and deposited all over the city, where they terrorize residents.',
